...
public interface OberonGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link OberonGrammarParser#importDefinition}.
	 * @param ctx the parse tree
	 */
	void enterImportDefinition(OberonGrammarParser.ImportDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link OberonGrammarParser#importDefinition}.
	 * @param ctx the parse tree
	 */
	void exitImportDefinition(OberonGrammarParser.ImportDefinitionContext ctx);
	/**
